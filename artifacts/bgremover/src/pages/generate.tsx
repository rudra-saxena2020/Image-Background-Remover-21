...
const STRICT_PRODUCT_IDENTITY_PROMPT = `STRICT PRODUCT IDENTITY LOCK — the first supplied reference image is the absolute and immutable source of truth. Generate the exact same physical product, not a similar product or a new colorway.
